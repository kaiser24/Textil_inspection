...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "fast_localEnergy",
        "sources": [
            "/home/felipe/UdeA2/Textil_inspection/fast_localEnergy.pyx"
        ]
    },
    "module_name": "fast_localEnergy"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fast_localEnergy
#define __PYX_HAVE_API__fast_localEnergy
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
/* Module declarations from 'fast_localEnergy' */
...
static __Pyx_memviewslice __pyx_f_16fast_localEnergy_localEnergy(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "fast_localEnergy"
extern int __pyx_module_is_main_fast_localEnergy;
int __pyx_module_is_main_fast_localEnergy = 0;

/* Implementation of 'fast_localEnergy' */
...
static const char __pyx_k_r_img[] = "r_img";
static const char __pyx_k_range[] = "range";
static const char __pyx_k_shape[] = "shape";
static const char __pyx_k_start[] = "start";
static const char __pyx_k_sum_1[] = "sum_1";
...
static const char __pyx_k_img_eng[] = "img_eng";
static const char __pyx_k_memview[] = "memview";
static const char __pyx_k_sqsum_2[] = "sqsum_2";
...
static const char __pyx_k_Created_on_Mon_Oct_7_17_43_10_2[] = "\nCreated on Mon Oct  7 17:43:10 2019\n\n@author: luisf\n";
...
static PyObject *__pyx_n_s_img_eng;
...
static PyObject *__pyx_n_s_r_img;
...
static PyObject *__pyx_n_s_sqsum_2;
...
static PyObject *__pyx_pf_16fast_localEnergy_localEnergy(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sum_1, __Pyx_memviewslice __pyx_v_sqsum_2, __Pyx_memviewslice __pyx_v_img_eng, int __pyx_v_r_img, int __pyx_v_c_img, int __pyx_v_wsize); /* proto */
...
static PyObject *__pyx_pw_16fast_localEnergy_1localEnergy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_16fast_localEnergy_localEnergy(__Pyx_memviewslice __pyx_v_sum_1, __Pyx_memviewslice __pyx_v_sqsum_2, __Pyx_memviewslice __pyx_v_img_eng, int __pyx_v_r_img, int __pyx_v_c_img, int __pyx_v_wsize, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n;
  int __pyx_v_i;
  int __pyx_v_j;
  double __pyx_v_s1;
  ...
  __Pyx_RefNannySetupContext("localEnergy", 0);

  /* "fast_localEnergy.pyx":17
 *     cdef double s1, s2
 * 
 *     n = wsize**2             # <<<<<<<<<<<<<<
 *     r_end = r_img - (wsize -1)
 *     c_end = c_img - (wsize -1)
 */
  __pyx_v_n = __Pyx_pow_long(((long)__pyx_v_wsize), 2);

  /* "fast_localEnergy.pyx":18
 * 
 *     n = wsize**2
 *     r_end = r_img - (wsize -1)             # <<<<<<<<<<<<<<
 *     c_end = c_img - (wsize -1)
 * 
 */
  __pyx_v_r_end = (__pyx_v_r_img - (__pyx_v_wsize - 1));

  /* "fast_localEnergy.pyx":19
 *     n = wsize**2
 *     r_end = r_img - (wsize -1)
 *     c_end = c_img - (wsize -1)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_v_c_end = (__pyx_v_c_img - (__pyx_v_wsize - 1));

  /* "fast_localEnergy.pyx":23
 * 
 ...
 */
  __pyx_t_1 = __pyx_v_r_end;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "fast_localEnergy.pyx":24
 *     #passing the window through all the image
 *     for i in range(0, r_end ):
 *         for j in range(0, c_end):             # <<<<<<<<<<<<<<
 *             s1 = sum_1[i + wsize,j + wsize ] + sum_1[i ,j] - sum_1[i,j + wsize ] - sum_1[i + wsize,j]
 ...
 */
    __pyx_t_4 = __pyx_v_c_end;
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "fast_localEnergy.pyx":25
 *     for i in range(0, r_end ):
 *         for j in range(0, c_end):
 *             s1 = sum_1[i + wsize,j + wsize ] + sum_1[i ,j] - sum_1[i,j + wsize ] - sum_1[i + wsize,j]             # <<<<<<<<<<<<<<
 *             s2 = sqsum_2[i + wsize,j + wsize ] + sqsum_2[i,j] - sqsum_2[i,j + wsize ] - sqsum_2[i + wsize,j]
 * 
 */
      __pyx_t_7 = (__pyx_v_i + __pyx_v_wsize);
      __pyx_t_8 = (__pyx_v_j + __pyx_v_wsize);
      __pyx_t_9 = __pyx_v_i;
      __pyx_t_10 = __pyx_v_j;
      __pyx_t_11 = __pyx_v_i;
      __pyx_t_12 = (__pyx_v_j + __pyx_v_wsize);
      __pyx_t_13 = (__pyx_v_i + __pyx_v_wsize);
      __pyx_t_14 = __pyx_v_j;
      __pyx_v_s1 = ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sum_1.data + __pyx_t_7 * __pyx_v_sum_1.strides[0]) ) + __pyx_t_8 * __pyx_v_sum_1.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sum_1.data + __pyx_t_9 * __pyx_v_sum_1.strides[0]) ) + __pyx_t_10 * __pyx_v_sum_1.strides[1]) )))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sum_1.data + __pyx_t_11 * __pyx_v_sum_1.strides[0]) ) + __pyx_t_12 * __pyx_v_sum_1.strides[1]) )))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sum_1.data + __pyx_t_13 * __pyx_v_sum_1.strides[0]) ) + __pyx_t_14 * __pyx_v_sum_1.strides[1]) ))));

      /* "fast_localEnergy.pyx":26
 *         for j in range(0, c_end):
 *             s1 = sum_1[i + wsize,j + wsize ] + sum_1[i ,j] - sum_1[i,j + wsize ] - sum_1[i + wsize,j]
 *             s2 = sqsum_2[i + wsize,j + wsize ] + sqsum_2[i,j] - sqsum_2[i,j + wsize ] - sqsum_2[i + wsize,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_15 = (__pyx_v_i + __pyx_v_wsize);
      __pyx_t_16 = (__pyx_v_j + __pyx_v_wsize);
      __pyx_t_17 = __pyx_v_i;
      __pyx_t_18 = __pyx_v_j;
      __pyx_t_19 = __pyx_v_i;
      __pyx_t_20 = (__pyx_v_j + __pyx_v_wsize);
      __pyx_t_21 = (__pyx_v_i + __pyx_v_wsize);
      __pyx_t_22 = __pyx_v_j;
      __pyx_v_s2 = ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sqsum_2.data + __pyx_t_15 * __pyx_v_sqsum_2.strides[0]) ) + __pyx_t_16 * __pyx_v_sqsum_2.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sqsum_2.data + __pyx_t_17 * __pyx_v_sqsum_2.strides[0]) ) + __pyx_t_18 * __pyx_v_sqsum_2.strides[1]) )))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sqsum_2.data + __pyx_t_19 * __pyx_v_sqsum_2.strides[0]) ) + __pyx_t_20 * __pyx_v_sqsum_2.strides[1]) )))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sqsum_2.data + __pyx_t_21 * __pyx_v_sqsum_2.strides[0]) ) + __pyx_t_22 * __pyx_v_sqsum_2.strides[1]) ))));

      /* "fast_localEnergy.pyx":28
 *             s2 = sqsum_2[i + wsize,j + wsize ] + sqsum_2[i,j] - sqsum_2[i,j + wsize ] - sqsum_2[i + wsize,j]
 * 
 *             img_eng[i,j] = sqrt( (s2 - (s1**2)/n)/n )             # <<<<<<<<<<<<<<
 * 
 * 
 */
      __pyx_t_23 = pow(__pyx_v_s1, 2.0);
      if (unlikely(__pyx_v_n == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      __pyx_t_24 = (__pyx_v_s2 - (__pyx_t_23 / __pyx_v_n));
      if (unlikely(__pyx_v_n == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_eng.data + __pyx_t_25 * __pyx_v_img_eng.strides[0]) ) + __pyx_t_26 * __pyx_v_img_eng.strides[1]) )) = sqrt((__pyx_t_24 / __pyx_v_n));
    }
  }

  /* "fast_localEnergy.pyx":31
 * 
 * 
 *     return img_eng             # <<<<<<<<<<<<<<
 * #%%
 */
  __PYX_INC_MEMVIEW(&__pyx_v_img_eng, 0);
  __pyx_r = __pyx_v_img_eng;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("fast_localEnergy.localEnergy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_16fast_localEnergy_1localEnergy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_16fast_localEnergy_1localEnergy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_sum_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_sqsum_2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_img_eng = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_r_img;
  int __pyx_v_c_img;
  int __pyx_v_wsize;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("localEnergy (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sum_1,&__pyx_n_s_sqsum_2,&__pyx_n_s_img_eng,&__pyx_n_s_r_img,&__pyx_n_s_c_img,&__pyx_n_s_wsize,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sum_1)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sqsum_2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("localEnergy", 1, 6, 6, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img_eng)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("localEnergy", 1, 6, 6, 2); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_r_img)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("localEnergy", 1, 6, 6, 3); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c_img)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("localEnergy", 1, 6, 6, 4); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_wsize)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("localEnergy", 1, 6, 6, 5); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "localEnergy") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
    ...
    __pyx_v_sum_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sum_1.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_sqsum_2 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sqsum_2.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_img_eng = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img_eng.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_r_img = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_r_img == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_c_img = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_c_img == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_wsize = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_wsize == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("localEnergy", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("fast_localEnergy.localEnergy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16fast_localEnergy_localEnergy(__pyx_self, __pyx_v_sum_1, __pyx_v_sqsum_2, __pyx_v_img_eng, __pyx_v_r_img, __pyx_v_c_img, __pyx_v_wsize);
...
static PyObject *__pyx_pf_16fast_localEnergy_localEnergy(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sum_1, __Pyx_memviewslice __pyx_v_sqsum_2, __Pyx_memviewslice __pyx_v_img_eng, int __pyx_v_r_img, int __pyx_v_c_img, int __pyx_v_wsize) {
  ...
  if (unlikely(!__pyx_v_sum_1.memview)) { __Pyx_RaiseUnboundLocalError("sum_1"); __PYX_ERR(0, 13, __pyx_L1_error) }
  if (unlikely(!__pyx_v_sqsum_2.memview)) { __Pyx_RaiseUnboundLocalError("sqsum_2"); __PYX_ERR(0, 13, __pyx_L1_error) }
  if (unlikely(!__pyx_v_img_eng.memview)) { __Pyx_RaiseUnboundLocalError("img_eng"); __PYX_ERR(0, 13, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_16fast_localEnergy_localEnergy(__pyx_v_sum_1, __pyx_v_sqsum_2, __pyx_v_img_eng, __pyx_v_r_img, __pyx_v_c_img, __pyx_v_wsize, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 13, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_sum_1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_sqsum_2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_img_eng, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fast_localEnergy.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_localEnergy.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_localEnergy._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"localEnergy", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_16fast_localEnergy_1localEnergy, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_fast_localEnergy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fast_localEnergy},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "fast_localEnergy",
    __pyx_k_Created_on_Mon_Oct_7_17_43_10_2, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_img_eng, __pyx_k_img_eng, sizeof(__pyx_k_img_eng), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_r_img, __pyx_k_r_img, sizeof(__pyx_k_r_img), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_sqsum_2, __pyx_k_sqsum_2, sizeof(__pyx_k_sqsum_2), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initfast_localEnergy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initfast_localEnergy(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_fast_localEnergy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fast_localEnergy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fast_localEnergy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fast_localEnergy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_fast_localEnergy(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("fast_localEnergy", __pyx_methods, __pyx_k_Created_on_Mon_Oct_7_17_43_10_2, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fast_localEnergy) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fast_localEnergy")) {
      if (unlikely(PyDict_SetItemString(modules, "fast_localEnergy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fast_localEnergy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fast_localEnergy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
